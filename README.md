...
- How to work with the NYC Open Data API
- I'm not sure if the way I dealt with this large # of rows (1.1 million) is the *best* way to handle it, but it worked out okay!